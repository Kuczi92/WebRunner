 ...
 * @author Quchi
 */
@WebServlet(name = "DeleteYourselfFromEvent", urlPatterns = {"/DeleteYourselfFromEvent"})
public class DeleteYourselfFromEvent extends HttpServlet {
  /**
   ...
   Event currentEvent = null;
      EntityManager em = DatabaseConnection.getEntityManager();
           ...
           em.getTransaction() //rozpoczęcie tranzakcji    
            .begin();
               ...
               User user = (User) query.getSingleResult();
                ...
                Model.Number Number = (Model.Number) NumberExistquery.getSingleResult();
        ...
        if(redirect){
            ...
            request.getRequestDispatcher("currentEvent.jsp?error="+ErrorMessage.replace(" ", "_")).forward(request, response);
        }
    }
