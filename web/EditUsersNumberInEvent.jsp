<%-- 
    Document   : EditUsersNumberInEvent
    Created on : 2017-09-07, 20:37:51
    Author     : Quchi
--%>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <h1>Edytuj numer zapisanego użytkownika.</h1>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    %>
                           ...
                           <tr>
                              ...
                              <td>
                                  ...
                                  <form class="form-inline" name="DeleteChoosenPicture"  method="post" action="EditNumbersInEvent">
                                      <div class="form-group row">
                                          <div class="col-md-5 col-sm-8">
                                              <input name="inputNewNumber" type="text" class="form-control" placeholder="Wpisz nowy numer" required />
                                          </div>
                                          <div class="col-md-8 col-sm-8">
                                              <button class="btn btn-lg btn-primary btn-block" type="submit" name="ChoosenUserNameEditNumber" value="<%out.print(CurrentUser.getUsername());%>" >Zmień</button>
                                          </div>
                                      </div>     
                                  </form>
