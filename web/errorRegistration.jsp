<%-- 
    ...
    Created on : 2017-08-30, 16:56:53
    Author     : Quchi
--%>
...
<html>
  <head>
    <title>WebRunner - rejestracja</title>
    ...
    <div class="container">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <form class="form-signin" method="post" action="registration" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <span class="input-group-btn">
                                <span class="btn btn-default btn-file">
                                    Przeglądaj <input type="file" id="imgInp" name = "inputAvatar">
                                </span>
                            </span>
                ...
                <h2 class="form-signin-heading"><% out.print(request.getAttribute("error")); %></h2>
            </form>
        </div>
    </div>
